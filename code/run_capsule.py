...
# LOCAL
URL = "https://github.com/AllenNeuralDynamics/aind-ephys-spikesort-spykingcircus2"
VERSION = "1.0"
...
parser = argparse.ArgumentParser(description="Spike sort ecephys data with SpykingCircus2")
...
min_drift_channels_help = (
    "Minimum number of channels to enable SpykingCircus2 motion correction. Default is 64."
)
...
if __name__ == "__main__":
    ...
    for recording_folder in preprocessed_folders:
        ...
        if recording.get_num_segments() > 1 and not SKIP_MOTION_CORRECTION:
        ...
        try:
            ...
            spikesorting_notes += f"\n- SC2 found {n_original_units} units, "
